...
# query wd, output in json
            print("\nInput file: {}\nEloBot is going to check and possibly write claims with these values:"
                ...
                "\n        stated in ({}) - ratings.fide.com ({})".format(input_csv_file, year_of_rating, month_of_rating,
                                                                                year_of_retrieval, month_of_retrieval, day_of_retrieval,
                                                                                fide_id_property, stated_in_property, fide_web_item))
            ...
            for player in item_list:
                ...
                try:
                    ...
                    if fide_id not in fide_ratings:
                        print(("Fide id {} for item {} was NOT found in the input file.\n").format(fide_id, wd_item))
